...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("service", "create_service_inbound_api", [SERVICE_ONE_ID] + [""] * 4, {}),
        ...
        ("service", "create_delivery_status_callback_api", [SERVICE_ONE_ID] + [""] * 4, {}),
        ("service", "create_returned_letters_callback_api", [SERVICE_ONE_ID] + [""] * 4, {}),
