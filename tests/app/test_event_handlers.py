...
def test_on_user_logged_in_calls_events_api(app, api_user_active, mock_events):

    with app.test_request_context():
        on_user_logged_in(app, User(api_user_active))
...
def test_create_email_change_event_calls_events_api(app, mock_events):
...
def test_create_add_user_to_service_event_calls_events_api(app, mock_events):
    user_id = str(uuid.uuid4())
...
def test_create_remove_user_from_service_event_calls_events_api(app, mock_events):
    user_id = str(uuid.uuid4())
...
def test_create_mobile_number_change_event_calls_events_api(app, mock_events):
    user_id = str(uuid.uuid4())
    updated_by_id = str(uuid.uuid4())
...
def test_create_archive_user_event_calls_events_api(app, mock_events):
    user_id = str(uuid.uuid4())
...
def test_create_broadcast_account_type_change_event(app, mock_events):
    service_id = str(uuid.uuid4())
