...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("letter_branding", None, sample_uuid(), "Updated the logo on this service’s letters"),
        ("letter_branding", sample_uuid(), None, "Removed the logo from this service’s letters"),
