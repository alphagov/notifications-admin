...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("tests/non_spreadsheet_files/without brackets.txt", None),
        ("tests/non_spreadsheet_files/with (brackets).txt", "File name cannot contain brackets"),
        ("tests/non_spreadsheet_files/no extension", "Not an allowed file format"),
    ),
)
