...
def test_report_request_download_blocks_access_to_different_services(client_request, fake_uuid, mocker):
    report_request = create_report_request(service_id=SERVICE_ONE_ID, user_id=fake_uuid)
    mocker.patch("app.report_request_api_client.get_report_request", return_value={"data": report_request})
