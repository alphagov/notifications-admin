...
@pytest.mark.parametrize(
    ...
    [
        ...
        (None, "sending", True, "Sent via MMG"),
        ...
        ("test", "sending", False, "Sent (test)"),
        ("test", "sending", True, "Sent via MMG (test)"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            partial(url_for, "main.view_notifications", message_type="sms", status="sent"),
        ),
        (
