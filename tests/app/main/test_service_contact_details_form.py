...
def test_form_fails_validation_with_no_radio_buttons_selected(app):
...
def test_form_url_validation_fails_with_invalid_url_field(app):
...
def test_form_email_validation_fails_with_invalid_email_address_field(app):
...
def test_form_phone_number_validation_fails_with_invalid_phone_number_field(app):
