...
@main.route("/services/<uuid:service_id>/service-settings/confirm-unique", methods=["GET", "POST"])
@user_has_permissions("manage_service")
def service_confirm_unique(service_id):
    ...
    return render_template("views/service-settings/unique-service.html", form=form)
