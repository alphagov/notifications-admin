...
def support_cannot_sign_in():
    ...
    if form.validate_on_submit():
        ...
        elif form.sign_in_issue.data == "phone-number-changed":
            return redirect(url_for("main.support_phone_number_changed"))
...
@main.route("/support/phone-number-changed")
@hide_from_search_engines
def support_phone_number_changed():
    return render_template("views/support/phone-number-changed.html")
