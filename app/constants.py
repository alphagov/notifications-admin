...
MIN_LETTER_PRICE = min(pennies for prices in LETTER_PRICES.values() for pennies in prices.values())
MAX_LETTER_PRICE = max(pennies for prices in LETTER_PRICES.values() for pennies in prices.values())
