...
class FullscreenTable {
  ...
  constructor($module) {
    ...
    console.log('top offset:', this.topOffset,  this.$module.getBoundingClientRect().top, $(this.$module).offset().top)
  ...
  maintainHeight() {
    ...
    console.log(window.innerHeight - (this.topOffset + window.scrollY))
    console.log(window.innerHeight)
    console.log(this.topOffset, 'component offset top')
  ...
  maintainWidth() {
    ...
    if (!scrollableIndexColumnHeader || !fixedIndexColumnHeader) return;
    ...
    if (fixedIndexColumnHeader.offsetWidth !== scrollableIndexColumnHeader.offsetWidth) {
      scrollableIndexColumnHeader.style.width = `${fixedIndexColumnHeader.offsetWidth}px`;
    }

    // Set the width of the fixed table container to match its first column
    this.$fixedTable.style.width = `${fixedIndexColumnHeader.offsetWidth + 4}px`; // 4px for shadow
  }
