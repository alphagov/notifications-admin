import { cookie, setConsentCookie } from './govuk/cookie-functions.mjs';
...
CookieBanner.prototype.showCookieMessage = function () {
  ...
  if (!this.isInCookiesPage()) {
    var hasCookiesPolicy = cookie('cookies_policy');
...
NotifyModules.CookieBanner = CookieBanner;
