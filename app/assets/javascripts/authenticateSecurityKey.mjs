    ...
    $(component)
      .on('click', function (event) {
        ...
        fetch('/webauthn/authenticate')
          ...
          .then(cbor => {
            return Promise.resolve(CBOR.decode(cbor));
          })
          .then(data => {
